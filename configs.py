...
CRAZY_PARMANANT_URL = os.environ.get("CRAZY_PARMANANT_URL", "https://telegramfilestorebot.blogspot.com/2024/12/test.html")
class Config(object):
...
📢 Send me any File & It will be uloaded in My Database & You will Get the File Link.
